...
const Work = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-medium mb-12 text-base-content">
        Work History
      </h1>
      <div className="space-y-12">
        <WorkCard
          ...
          description={[
            ...
            "• Configured Github Actions integration tests to run on both LTS and latest database versions, doubling testing pipeline throughput",
            "• Benchmarked the NodeJS wrapper, discovering an import bottleneck that made it 100× slower than the Java wrapper implementation",
          ]}
          company="Improving"
